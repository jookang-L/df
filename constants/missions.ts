...
export const MISSION_EASY: Mission[] = [
  ...
  },
  {
    id: "e-fire",
    title: "불 속성 포켓몬을 찾아라!",
    description: "Type 1이 'Fire'인 포켓몬만 필터링하세요.",
    hint: "df[df['열이름'] == '값'] 형식을 사용해보세요!",
    difficulty: "쉬움",
    targetCode: "df[df['Type 1'] == 'Fire']",
    validateFn: "boolean_filter:Type 1:Fire",
  },
  {
    id: "e-attack",
    title: "강력한 포켓몬을 찾아라!",
    description: "Attack이 100 이상인 포켓몬만 필터링하세요.",
    hint: "df[df['열이름'] >= 숫자] 형식을 사용해보세요!",
    difficulty: "쉬움",
  ...
  },
  {
    id: "e-electric",
    title: "전기 타입을 찾아라!",
    description: "Type 1이 'Electric'인 포켓몬만 필터링하세요.",
    hint: "df[df['Type 1'] == 'Electric']",
    difficulty: "쉬움",
    targetCode: "df[df['Type 1'] == 'Electric']",
    validateFn: "boolean_filter:Type 1:Electric",
  },
  {
    id: "e-speed",
    title: "스피드가 빠른 포켓몬!",
    description: "Speed가 100 초과인 포켓몬만 필터링하세요.",
...
export const MISSION_NORMAL: Mission[] = [
  {
    id: "n-cols",
    title: "이름과 타입만 보여줘!",
    description: "Name, Type 1, HP 열만 선택하세요.",
  ...
  },
  {
    id: "n-legend",
    title: "전설의 포켓몬을 찾아라!",
    description: "Legendary가 True인 포켓몬만 찾으세요. (df.loc 생략 가능)",
  ...
  },
  {
    id: "n-gen",
    title: "5세대 포켓몬!",
    description: "Generation이 5인 포켓몬만 필터링하세요.",
  ...
  },
  {
    id: "n-defense",
    title: "방어력이 높은 포켓몬!",
    description: "Defense가 100 이상인 포켓몬만 필터링하세요.",
...
export const MISSION_HARD: Mission[] = [
  {
    ...
    description: "Type 1이 'Water'인 포켓몬의 Name과 HP만 가져오세요. (loc 생략 시 체인 인덱싱)",
    hint: "df.loc[조건, ['열1','열2']] 또는 df[조건][['열1','열2']]",
    difficulty: "어려움",
    targetCode: "df.loc[df['Type 1'] == 'Water', ['Name', 'HP']]",
    validateFn: "loc_filter_cols|Type 1|Water|Name,HP",
  },
  {
    id: "h-hp-atk",
    title: "체력이 높은 강한 포켓몬!",
    description: "HP가 90 초과이고 Attack이 100 초과인 포켓몬을 찾으세요.",
    hint: "df[(조건1) & (조건2)]",
    difficulty: "어려움",
  ...
  },
  {
    id: "h-grass-cols",
    title: "풀 타입의 핵심 스탯!",
    description: "Type 1이 'Grass'인 포켓몬의 Name, Attack, Speed만 가져오세요.",
    hint: "loc 또는 체인 인덱싱",
    difficulty: "어려움",
    targetCode: "df.loc[df['Type 1'] == 'Grass', ['Name', 'Attack', 'Speed']]",
    validateFn: "loc_filter_cols|Type 1|Grass|Name,Attack,Speed",
  },
  {
    id: "h-psychic",
    title: "에스퍼 타입 스펙!",
    description: "Type 1이 'Psychic'인 포켓몬의 Name과 Sp. Atk만 가져오세요.",
    hint: "열 이름에 공백이 있으면 그대로 따옴표에 넣으세요.",
    difficulty: "어려움",
    targetCode: "df.loc[df['Type 1'] == 'Psychic', ['Name', 'Sp. Atk']]",
    validateFn: "loc_filter_cols|Type 1|Psychic|Name,Sp. Atk",
  },
  {
    id: "h-legend-stats",
    title: "전설의 공격과 방어!",
    description: "Legendary가 True인 포켓몬의 Name, Attack, Defense만 가져오세요.",
